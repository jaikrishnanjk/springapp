...
.controller('ListCtrl', function ($scope, $ionicPopup,$timeout,$window) {
$scope.toggleGroup = function(item) {
  ...
  $scope.items = [
    {
      id: "Which Is your favourite colour ?",
	  options:[
	  {
	  opt:"Red"
	  },
 ...
 $scope.showsuccess = function () {
	   ...
	   var setChooseTemplate = function() {
                    $ionicPopup.alert({
       title: 'Success',
       content: 'Your Ansewer Submitted successfully'
     });
	 $window.location.href="#/menu/tab/list";
                };
                $timeout(setChooseTemplate, 1000);
